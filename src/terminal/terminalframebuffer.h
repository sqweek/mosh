...
namespace Terminal {
  ...
  private:
    ...
    bool osc_received; /* true if an OSC has ever been received */
  ...
  public:
    ...
    void set_osc_received( void ) { osc_received = true; }
    bool get_osc_received( void ) const { return osc_received; }
